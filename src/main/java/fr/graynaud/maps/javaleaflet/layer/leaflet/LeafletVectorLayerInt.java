...
/**
 * The {@code LeafletVectorLayerInt} interface defines methods for adding and managing vector-based elements such as polylines, polygons, circles, and circle
 * markers in a Leaflet map. Leaflet is a popular JavaScript library for creating interactive maps, and this interface provides a Java API for working with
 * vector-based layers within Leaflet.
 *
...
public interface LeafletVectorLayerInt {
     ...
     *
     * @param vertices An array of geographical coordinates (latitude and longitude) that define the vertices of the polyline.
     *
     ...
     *
     * @return {@code true} if the polyline was successfully removed, {@code false} if the polyline with the specified identifier was not found.
     */
     ...
     *
     * @param vertices An array of arrays of geographical coordinates (latitude and longitude) that define the vertices of multiple polylines.
     *
     ...
     *
     * @return {@code true} if the multi-polyline was successfully removed, {@code false} if the multi-polyline with the specified identifier was not found.
     */
     ...
     *
     * @param vertices An array of arrays of geographical coordinates (latitude and longitude) that define the vertices of the polygon.
     ...
     *
     * @return {@code true} if the polygon was successfully removed, {@code false} if the polygon with the specified identifier was not found.
     */
     ...
     *
     * @return {@code true} if the circle was successfully removed, {@code false} if the circle with the specified identifier was not found.
     */
     ...
     *
     * @return {@code true} if the circle marker was successfully removed, {@code false} if the circle marker with the specified identifier was not found.
     */
