...
/**
 * The {@code LeafletControlLayerInt} interface defines methods for controlling the zoom and view of a Leaflet map. Leaflet is a popular JavaScript library for
 * creating interactive maps, and this interface provides a Java API for manipulating the map's zoom level, view, and geographical bounds.
 *
