...
/**
 * The {@code LeafletGeoJsonLayerInt} interface defines methods for adding and managing GeoJSON data layers in a Leaflet map.
 * <p>
 * Implementations of this interface should provide methods to add GeoJSON data from various sources, such as files, URLs, or raw content, as well as the
 * ability to remove GeoJSON objects from the map.
 *
...
public interface LeafletGeoJsonLayerInt {
     ...
     */
    JLGeoJsonObject addFromFile(File file) throws JLException;
     ...
     * @throws JLException If there is an error while adding the GeoJSON data.
     */
    JLGeoJsonObject addFromUrl(String url) throws JLException;
     ...
     * @throws JLException If there is an error while adding the GeoJSON data.
     */
    JLGeoJsonObject addFromContent(String content) throws JLException;
     ...
     *
     * @return {@code true} if the removal was successful, {@code false} if the object was not found or could not be removed.
     */
    boolean removeGeoJson(JLGeoJsonObject object);
